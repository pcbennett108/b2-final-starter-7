...
RSpec.describe Item, type: :model do
  ...
  describe "instance methods" do
    ...
    it "applicable discout(quantity)" do
      @merchant1 = Merchant.create!(name: 'Hair Care')
      @merchant2 = Merchant.create!(name: 'Jewelry')

      @discount1 = Discount.create!(percentage: 10, threshold: 5, merchant_id: @merchant1.id)
      ...
      expect(@item_1.applicable_discount(6)).to eq(@discount1)
      expect(@item_1.applicable_discount(3)).to eq(nil)
    end
  end
end
